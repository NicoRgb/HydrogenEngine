...
struct EditorAnimTransition
{
	...
	std::vector<Hydrogen::Condition> Conditions;
};

struct EditorAnimState
{
	ed::NodeId ID;
	std::string Name;
...
private:
	...
	std::vector<Hydrogen::AnimParameter> m_Parameters;
	std::vector<EditorAnimState> m_States;
	std::vector<EditorAnimTransition> m_Transitions;
