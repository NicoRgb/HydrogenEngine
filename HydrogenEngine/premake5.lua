...
project "HydrogenEngine"
	...
	includedirs { "Include", "%{wks.location}/Extern/spdlog/include", "%{wks.location}/Extern/glm", "%{wks.location}/Extern/json/single_include/nlohmann", "%{wks.location}/Extern/entt/single_include", "%{wks.location}/Extern/imgui-docking", "%{wks.location}/Extern/ImTextEdit", "%{wks.location}/Extern/sol2/include", "%{wks.location}/Extern/reactphysics3d/include", "$(VULKAN_SDK)/Include" }
