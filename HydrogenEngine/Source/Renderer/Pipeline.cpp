...
{
    return std::make_shared<VulkanPipeline>(renderContext, renderGraph, vertexShaderAsset, fragmentShaderAsset, vertexLayout, descriptorBindings, pushConstantsRanges, primitive, cullMode);
}
